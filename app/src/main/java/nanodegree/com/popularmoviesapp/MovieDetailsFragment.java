...
import nanodegree.com.popularmoviesapp.adapters.MovieReviewsAdapter;
import nanodegree.com.popularmoviesapp.adapters.MovieTrailersAdapter;
...
public class MovieDetailsFragment extends Fragment
    ...
    @InjectView( R.id.tv_movie_title ) TextView mMovieTitleTextView;
    @InjectView( R.id.tv_rating ) TextView mMovieRatingTextView;
    @InjectView( R.id.tv_release_date ) TextView mMovieReleaseDateTextView;
    @InjectView( R.id.tv_movie_overview ) TextView mMovieOverviewTextView;
    @InjectView( R.id.iv_movie_poster ) ImageView mPosterImageView;
    @InjectView( R.id.rv_movies_trailer) RecyclerView mTrailerRecyclerView;
    @InjectView( R.id.rv_movies_reviews) RecyclerView mReviewsRecyclerView;
    @InjectView( R.id.tb_add_to_fav) ToggleButton mAddToFavouriteButton;
    ...
    private final LoaderManager.LoaderCallbacks< ArrayList< MoviesReview > > mReviewLoaderCallback =
            new LoaderManager.LoaderCallbacks< ArrayList< MoviesReview > >() {
                ...
                public void onLoadFinished(
                        Loader< ArrayList< MoviesReview > > loader,
